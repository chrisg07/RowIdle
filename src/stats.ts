...
export function createStatDisplays(): void {
  ...
  statDisplays['max-spm'] = new StatDisplay('max-spm-display', 'Max SPM', '', () => state.maxSPM.toFixed(0)
  );
  ...
  statDisplays['speed'] = new StatDisplay('speed-display', 'Speed', 'm/s', () => state.speed.toFixed(2)
  );
  statDisplays['drag'] = new StatDisplay('drag-display', 'Drag', '%', () => (state.drag * 100).toFixed(0)
  );
  statDisplays['distance'] = new StatDisplay('distance-display', 'Distance', 'm', () => state.distance.toFixed(2)
  );
}
